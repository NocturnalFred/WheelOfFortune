...
Fred Rodd and Micheal Ritchhart.


Special Instructions: 1 player mode has a timer and a maximum number of "losing"
moves.
	1 and 2 player mode only play for 1 round.
	3 player mode plays 2 rounds.

Interface: Users shouldn't be able to mess up, but basically choose the version 
...
If working with a partner, include a description of the separation of work (who was responsible for what pieces of the program).
...
I wish that our GUI were better looking.  The main game 
lacks a clean feel to it.  
****************************************************************
